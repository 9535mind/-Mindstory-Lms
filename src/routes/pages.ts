                ...
                <div class="space-y-3">
                    ...
                    <div class="relative">
                        <button disabled 
                            ...
                            <span class="text-lg font-semibold text-gray-500">Google (설정 중)</span>
                        </button>
                ...
                <div class="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <div class="flex items-start gap-2">
                        ...
                        <div class="text-sm text-gray-700">
                            <p class="font-semibold mb-2">🔧 시스템 안내</p>
                            <ul class="space-y-1 ml-4 list-disc">
                                <li><strong>이메일 회원가입</strong>: 지금 바로 사용 가능합니다! ✅</li>
                                <li><strong>전화번호 가입</strong>: 테스트 모드로 작동 중 (인증번호: 123456)</li>
                                <li><strong>소셜 로그인</strong>: Google/카카오 설정 진행 중입니다.</li>
                            </ul>
                        </div>
                    </div>
                </div>
