...
**Ver.2.1 - Major UX Improvements & Certification System (2025.12.28)** 🚀
...
- **홈페이지 이미지**: 전문 교육 현장 이미지로 업데이트

### **민간자격 시스템 확장**
- **직접 발급**: (주)마인드스토리 자체 자격증
- **기관 연계**: 평생교육진흥회, 메타인지학습연구회, 한국청소년상담복지개발원
- **관리자 CRUD**: 자격명/코드/발급기관/등록번호 직접 입력 가능
- **신청 접수 대행**: 연계 기관 자격 신청 접수 지원
...
### 최신 버전 (v1.4.0 - With Toss Payments)
...
- ✅ 교육원 소개 페이지 추가 (대표 프로필/교육이념)
- ✅ 종합 운영 문서 작성 (체크리스트/연동 가이드)
- ✅ 최종 종합 보고서 작성
- ✅ 프로덕션 준비 완료
