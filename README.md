...
### 📹 이중 영상 업로드 시스템 ⭐ NEW!
차시에 영상을 등록할 때 **YouTube URL 방식**과 **직접 파일 업로드** 2가지 방식을 선택할 수 있습니다!

#### **방식 1: YouTube URL (무료, 무제한)**
...
2. **영상 설정** 탭에서 방식 선택:
   ...
   - **직접 업로드 탭**: 파일 선택 또는 드래그 앤 드롭
3. 업로드 완료 후 저장

#### **Cloudflare R2 무료 한도**
- 저장 공간: 10GB/월 (약 100개 영상)
- 업로드: 1,000,000 요청/월
- 다운로드: 10,000,000 요청/월
- 초과 시: $0.015/GB/월 (매우 저렴)
